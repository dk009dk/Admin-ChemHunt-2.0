...
### Fixed
- Map related Admin model [#1544](https://github.com/orchidsoftware/platform/pull/1544)
...
- Request validation for `Admin` screen
...
### Added
- Admin filter for foles [823](https://github.com/orchidsoftware/platform/pull/823)
...
### Deprecated
- Method `getStatusRoles()` for Admin model
